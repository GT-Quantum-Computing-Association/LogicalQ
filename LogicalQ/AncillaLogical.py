...
class LogicalReservoirCircuit(QuantumCircuit):
    """
    ...
    def insert_qec_cycles(
        ...
        # BOOKMARK
        # @TODO redo implementation for ancilla reservoir
        raise NotImplementedError("Functionality temporarily removed while AncillaReservoir logic is added.")
    ...
    def remove_final_measurements(
        ...
        lqc_no_meas = LogicalReservoirCircuit(self.n_logical_qubits, self.label, self.stabilizer_tableau, self.name + "_no_meas")
