...
def _logical_matplotlib_circuit_drawer(
    circuit,
    scale=None,
    filename=None,
    style=None,
            ...
            for i, node in enumerate(layer):
                ...
                if (
                    ...
                    raw_gate_width = self._get_text_width(
                        op.label.split(":")[-1], glob_data, fontsize=self._style["fs"]
                    )
                ...
                # @TODO - check whether this is problematic
    ...
    def _draw_ops(
        ...
        for layer in nodes:
            ...
            for node in layer:
                ...
                # Condense logical operations if specified
                elif self.fold_logicalop and op.label is not None and op.label.startswith("logical.logicalop"):
                    node_data[node].gate_text = op.label.split(":")[-1]
                    self._multiqubit_gate(node, node_data, glob_data)
