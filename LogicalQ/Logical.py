...
class LogicalCircuitLegacy(QuantumCircuit):
    """
    ...
    def remove_final_measurements(
        ...
        lqc_no_meas = LogicalCircuitLegacy(self.n_logical_qubits, self.label, self.stabilizer_tableau, self.name + "_no_meas")
...
class LogicalCircuit(QuantumCircuit):
    ...
    def from_physical_circuit(
        ...
        Returns:
            The LogicalCircuit constructed from the physical.
        """
        logical_circuit = cls(physical_circuit.num_qubits, label, stabilizer_tableau, name, num_ancillas)
